        ...
        <section id="venue" className="wow fadeInUp">
          <div className="container-fluid">
            ...
            <div className="row no-gutters">
              <div className="col-lg-6 venue-map"></div>
